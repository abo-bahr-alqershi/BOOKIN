...
import 'features/search/domain/usecases/get_search_filters_usecase.dart' as search_usecases;
import 'features/search/domain/usecases/get_search_suggestions_usecase.dart' as search_usecases;
...
import 'features/property/domain/usecases/get_property_reviews_usecase.dart' as property_reviews_usecase;
...
import 'features/favorites/domain/usecases/get_favorites_usecase.dart' as fav_get;
import 'features/favorites/domain/usecases/add_to_favorites_usecase.dart' as fav_add;
import 'features/favorites/domain/usecases/remove_from_favorites_usecase.dart' as fav_remove;
import 'features/favorites/domain/usecases/check_favorite_status_usecase.dart' as fav_check;
...
void _initSearch() {
	...
	sl.registerLazySingleton(() => search_usecases.GetSearchSuggestionsUseCase(sl()));
...
void _initPropertyFeature() {
	...
	sl.registerLazySingleton(() => property_reviews_usecase.GetPropertyReviewsUseCase(repository: sl()));
