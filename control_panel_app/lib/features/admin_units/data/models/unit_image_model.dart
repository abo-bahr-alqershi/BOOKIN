// lib/features/admin_units/data/models/unit_image_model.dart
...
class ImageThumbnailsModel extends ImageThumbnails {
  ...
  factory ImageThumbnailsModel.fromJson(Map<String, dynamic> json, [String? fallbackUrl]) {
    ...
    return ImageThumbnailsModel(
      small: UnitImageModel._validateUrl(json['small'] ?? json['s'] ?? fallback),
      medium: UnitImageModel._validateUrl(json['medium'] ?? json['m'] ?? fallback),
      large: UnitImageModel._validateUrl(json['large'] ?? json['l'] ?? fallback),
