...
class _EditServicePageState extends State<EditServicePage> with TickerProviderStateMixin {
  ...
  void _prefillOrLoad() {
    ...
    if (initial != null) {
      ...
      _amountController.text = initial.price.amount.toString();
      _propertyName = initial.propertyName;
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          ...
          colors: [
            ...
            AppTheme.darkBackground2.withOpacity(0.85),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  'قم بتحديث بيانات الخدمة الحالية',
